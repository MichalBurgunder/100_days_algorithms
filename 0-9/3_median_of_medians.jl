...
function median_of_medians(array)
    ...
    while true
        ...
        # here we sort our given array, with the pivot with smaller/bigger
        # elements. If this is the first time we pass into this code, we know
        # that the median must be in the bigger array, which we recursively will
        # go into
        ...
        # median, and return this instead. For arrays of even numbers, we pick
        # out the left number (note that the Julia implementation takes the mean
        # of the two)
